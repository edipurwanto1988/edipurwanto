...
<h1 class="text-gray-900 dark:text-white text-3xl font-bold leading-tight">Edit Category</h1>
...
<form method="POST" action="{{ route('adminku.categories.update', $category) }}">
@csrf
@method('PUT')
